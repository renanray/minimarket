...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
        <a class="navbar-brand px-3 bg-warning"></a> <!-- Perhatikan, tag <a> tidak ditutup dengan benar -->
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="produk.php">
                        <span class="text-center d-block pt-2"><i class="fa fa-shopping-bag fa-2x"></i></span>Data Produk
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="kategori.php">
                        <span class="text-center d-block pt-2"><i class="fa fa-box-open fa-2x"></i></span>Kategori
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="laporan.php">
                        <span class="text-center d-block pt-2"><i class="fa fa-chart-bar fa-2x"></i></span>Data laporan
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="pengaturan.php">
                        <span class="text-center d-block pt-2"><i class="fa fa-cogs fa-2x"></i></span>Pengaturan
                    </a>
                </li>
                <li class="nav-item">
